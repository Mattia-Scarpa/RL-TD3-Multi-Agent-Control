...
from matd3_model import Critic, Actor
import torch
...
class Agent():
    ...
    def learn(self, experiences, gamma):
        ...
        with torch.no_grad():
            Q_target_next_1, Q_target_next_2 = self.critic_target(critic_target_input,all_next_actions.view(batch_size*2,-1)[::2])
        ...
        Q_expected = self.critic_local.Q1(critic_local_input,action)
        ...
        p_loss=-self.critic_local.Q1(critic_local_input2,action_pr_self).mean()
